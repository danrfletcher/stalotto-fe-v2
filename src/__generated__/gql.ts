 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation CreateBoodilPayment($uuid: String!, $consentToken: String!, $cartId: String!) {\n  createBoodilPayment(\n    input: {uuid: $uuid, consentToken: $consentToken, cartId: $cartId}\n  ) {\n    processingTime\n    uuid\n    reference\n    amount\n    currency\n  }\n}"): (typeof documents)["mutation CreateBoodilPayment($uuid: String!, $consentToken: String!, $cartId: String!) {\n  createBoodilPayment(\n    input: {uuid: $uuid, consentToken: $consentToken, cartId: $cartId}\n  ) {\n    processingTime\n    uuid\n    reference\n    amount\n    currency\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation CreateBoodilTransaction($cartId: String!) {\n  createBoodilTransaction(input: {cartId: $cartId}) {\n    uuid\n  }\n}"): (typeof documents)["mutation CreateBoodilTransaction($cartId: String!) {\n  createBoodilTransaction(input: {cartId: $cartId}) {\n    uuid\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query getSingleCompetition($sku: String!) {\n  products(filter: {sku: {eq: $sku}}) {\n    items {\n      sku\n      uid\n      short_description {\n        html\n      }\n      url_key\n      name\n      media_gallery_entries {\n        label\n        file\n      }\n      ... on VirtualProduct {\n        original_price\n        competition_closes_on\n        starting_ticket_qtd\n        creator\n        winning_ticket_ids\n      }\n      price_range {\n        minimum_price {\n          final_price {\n            value\n            currency\n          }\n        }\n      }\n      only_x_left_in_stock\n    }\n  }\n}"): (typeof documents)["query getSingleCompetition($sku: String!) {\n  products(filter: {sku: {eq: $sku}}) {\n    items {\n      sku\n      uid\n      short_description {\n        html\n      }\n      url_key\n      name\n      media_gallery_entries {\n        label\n        file\n      }\n      ... on VirtualProduct {\n        original_price\n        competition_closes_on\n        starting_ticket_qtd\n        creator\n        winning_ticket_ids\n      }\n      price_range {\n        minimum_price {\n          final_price {\n            value\n            currency\n          }\n        }\n      }\n      only_x_left_in_stock\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
