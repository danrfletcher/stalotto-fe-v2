...
const documents = {
    ...
    "mutation InitiateBoodilPayment($cartId: String!) {\n  initiateBoodilPayment(input: {cartId: $cartId}) {\n    uuid\n  }\n}": types.InitiateBoodilPaymentDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetSavedCustomerAddresses {\n  customer {\n    firstname\n    lastname\n    addresses {\n      id\n      firstname\n      lastname\n      company\n      street\n      city\n      region {\n        region\n        region_code\n      }\n      postcode\n      country_code\n      telephone\n      default_shipping\n      default_billing\n    }\n  }\n}"): (typeof documents)["query GetSavedCustomerAddresses {\n  customer {\n    firstname\n    lastname\n    addresses {\n      id\n      firstname\n      lastname\n      company\n      street\n      city\n      region {\n        region\n        region_code\n      }\n      postcode\n      country_code\n      telephone\n      default_shipping\n      default_billing\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation InitiateBoodilPayment($cartId: String!) {\n  initiateBoodilPayment(input: {cartId: $cartId}) {\n    uuid\n  }\n}"): (typeof documents)["mutation InitiateBoodilPayment($cartId: String!) {\n  initiateBoodilPayment(input: {cartId: $cartId}) {\n    uuid\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
