...
const AccountForm = () => {
    ...
    const { token, isLoggedIn, loginWorkflowState, user } =
                    ...
                    <div className="modal_centered">
                        ...
                        >
                            ...
                            <div className="form_head">
                                ...
                                loginWorkflowState === 'Unauthorized' ||
                                ...
                                ) : loginWorkflowState === 'AccountCreated' ? (
                                    <p>{`Account created successfully. To login, please check your emails to activate your account.`}</p>
                                ) : loginWorkflowState === 'LoggedIn' ? (
                                    <p>{`Welcome, ${user.email}, you have been logged in successfully.`}</p>
                                ) : (
