        ...
        <li className="post_comment">
            <div className="user_info">
                ...
                <input className="comment_input"
                    ...
                    onBlur={handleBlur}
                />
                <label className={`form_label${input === "" ? "" : " with_input"}`} htmlFor="comment">Add a comment...</label>
                {formFocus ? (
                <div className="comment_controls">
                    {valid ? (<button className="tabs_item comment_button" onClick={handlePostComment}>Comment</button>) : null}
                    <button className="tabs_item cancel_button" onClick={handleCancel}>Cancel</button>
                </div>
            ) : null}
            </form>
            </div>
