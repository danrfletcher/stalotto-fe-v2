...
const competitionsData: Competition[] = [
    {
        ...
        comments: [
            {
                ...
                comment:
                    "This is a propa class vehicle. If I win, I'm gonna smoke tac buckets in it with Trekka.",
                ...
                replies: [
                    {
                        ...
                        comment:
                            "I'll have tac buckets with you in it no problem.",
            ...
            {
                commentId: 5,
                username: 'conallsraiments',
                comment:
                    'Can we use it to ram raid the Ralph Lauren HQ before it ends?',
        ...
        description: (
            <p>
                2.4 litre D24tic 940, mechanical pump- making this the ideal
                veg-oil burner.
                <br />
                <br />
                the car is a very clean example, black interior with grey
                exterior, alloy wheels, turbo grill and a straight through
                sidepipe that blows black smoke
                <br />
                <br />
                The ultimate tax evading yoke, this machine will run on just
                about any flammable liquid you put in her (within reason)
            </p>
        ),
    },
    {
        id: 2,
        tag: 'featured-product',
        images: ['/images/competitions/defender-ambulance.png'],
