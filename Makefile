...
help:
	...
	@echo "$(call format,start dev vite,'Start Vite development server.')"
	@echo "$(call format,start dev vite --build,'Start and rebuild Vite development server.')"
	...
	@echo "$(call format,stop dev vite,'Stop Vite development server.')"
